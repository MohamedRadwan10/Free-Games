    ...
    <>
      <main>
        <div className=" row py-5 mt-4 ">
          <h1 className="Text">
            Top Free Zombie Games for PC and Browser In 2024!
          </h1>
          <span className="Text2">
            <b>17</b> free-to-play <b>Zombie games</b> found in our games list!
          </span>
